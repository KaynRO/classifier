...
export const jobsApi = {
  ...
  submit: (data: { domain_id: string; vendor?: string; bluecoat_service?: string }) => api.post('/jobs/submit', data),
  ...
  bulkSubmit: (vendor?: string, bluecoat_service?: string) => api.post('/jobs/bulk-submit', null, { params: { vendor, bluecoat_service } }),
